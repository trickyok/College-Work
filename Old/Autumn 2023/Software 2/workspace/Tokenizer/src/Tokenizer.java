...
public final class Tokenizer {
    ...
    private static String nextWordOrSeparator(String text, int position) {
        ...
        while (!done) {
        	if (text.length() < position + i + 1) {
            	done = true;
            } else {
	            if (SEPARATORS.contains(text.subSequence(position+i,position+i+1))) {
	                done = true;
	            } else {
    ...
    public static Queue<String> tokens(SimpleReader in) {
        ...
        Queue<String> tokens = new Queue2<String>();
        ...
        while (!in.atEOS()) {
	        ...
	        while (i < next.length()) {
	        	...
	        	newToken = nextWordOrSeparator(next, i);
    ...
    public static void main(String[] args) {
        ...
        if (q2.equals(q1)) {
            ...
            out.println("Expected: " + q1);
            out.println();
            out.println("Actual: " + q2);
        }
        out.println();
        /*
