...
public class Sequence3<T> extends SequenceSecondary<T> {
    ...
    public final void add(int pos, T x) {
        ...
        // move to left until left.length = pos
        setLengthOfLeftStack(this.left, this.right, pos);

        // put x into right
        this.right.push(x);

        // move left stuff back to right
    ...
    public final T remove(int pos) {
        ...
        // remove x from right
        T removed = this.right.pop();

        // put everything back into right
        setLengthOfLeftStack(this.left, this.right, 0);
    ...
    public final void flip() {
        ...
        // move everything to right from left, but backwards
        setLengthOfLeftStack(this.left, this.right, 0);
    ...
    public final T entry(int pos) {
        ...
        // move pos-1 items to left
        setLengthOfLeftStack(this.left, this.right, pos);

        // get first item in right
        T entry = this.right.top();
