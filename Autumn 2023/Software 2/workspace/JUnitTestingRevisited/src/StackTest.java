...
public abstract class StackTest {
	...
	/**
	 *
	 * Creates and returns a {@code Stack<String>} of the implementation under test
	 * type with the given entries.
	 *
	 * @param args the entries for the stack
	...
	/**
	 *
	 * Creates and returns a {@code Stack<String>} of the reference implementation
	 * type with the given entries.
	 *
	 * @param args the entries for the stack
	 * @return the constructed stack
	...
	/*
	 * Test StackKernel constructor(s) and methods. Note: these are just some sample
	 * test cases, not complete nor systematic.
	 */
	...
	/*
	 * Test StackCommon methods. Note: these are just some sample test cases, not
	...
	/*
	 * Test StackSecondary methods. Note: these are just some sample test cases, not
	 * complete nor systematic.
	 */
