...
public final class DemoView1 extends JFrame implements DemoView {
    ...
    /**
     * Storage String Arrays.
     */
    private ArrayList<String> outputLast = new ArrayList<>();
    private ArrayList<String> inputLast = new ArrayList<>();
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == this.resetButton) {
            if (!this.outputText.getText().equals("")) {
                this.outputLast.add(this.outputText.getText());
                this.inputLast.add(this.inputText.getText());
            ...
            if (this.outputLast.size() >= 1) {
                String out = this.outputLast.remove(this.outputLast.size() - 1);
                String in = this.inputLast.remove(this.inputLast.size() - 1);
                this.controller.processUndoEvent(out, in);
            }
