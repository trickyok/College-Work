...
public final class DemoController1 implements DemoController {
     ...
     *            value of input text (provided by view)
     * @param output
     *            value of current output (before append)
     */
     ...
     *
     * @param output
     *            value of previous output text
     */
    @Override
    public void processUndoEvent(String outputLast, String inputLast) {
        /*
         * Update model in response to this event
         */

        this.model.setInput(inputLast);
        this.model.setOutput(outputLast);
        /*
         * Update view to reflect changes in model
         */
        updateViewToMatchModel(this.model, this.view);
