...
#define ULTRASONIC_5V_PIN_PW	8
#define WATERLEVELSENSOR_PIN_SIG	9
...
char menu()
{
    ...
    Serial.println(F("(2) LV-MaxSonar-EZ1 - Ultrasonic Range Finder"));
    Serial.println(F("(3) Gravity: Non-contact Digital Water / Liquid Level Sensor"));
