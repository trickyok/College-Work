...
public final class RSSAggregator {
    ...
    private static void outputSubHeader(XMLTree xml, SimpleWriter out,
        ...
        writer.write("<html> <head> <title>"
                + xml.child(getChildElement(xml, "title")).child(0) + "</title>"
                + "\n");
        ...
        writer.write(
                "<p>" + xml.child(getChildElement(xml, "description")).child(0)
                        + "</p>" + "\n");
    ...
    private static int getChildElement(XMLTree xml, String tag) {
        ...
        while (i < xml.numberOfChildren() && xml.child(i).label() != tag) {
            i++;
        }
    ...
    private static void processSubItem(XMLTree item, SimpleWriter out,
        ...
        writer.write("<tr><td>"
                ...
                + "</td>" + "\n");
        if (item.child(getChildElement(item, "source")) != null) {
        ...
        if (item.child(getChildElement(item, "link")) != null
                && item.child(getChildElement(item, "title")) != null) {
            writer.write("<td><a href=\""
